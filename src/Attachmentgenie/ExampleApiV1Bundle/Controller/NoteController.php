...
namespace Attachmentgenie\ExampleApiV1\Controller;

use Attachmentgenie\ExampleApiV1\Form\NoteType;
use Attachmentgenie\ExampleApiV1\Model\Note;
use Attachmentgenie\ExampleApiV1\Model\NoteCollection;
 ...
 *
 * @package Attachmentgenie\ExampleApiV1\Controller
 * @author Gordon Franke <info@nevalon.de>
 */
class NoteController extends FOSRestController
{
    /**
     * return \Attachmentgenie\ExampleApiV1\NoteManager
     */
    public function getNoteManager()
    {
        return $this->get('Attachmentgenie.demo.note_manager');
    }
     ...
     *
     * @ApiDoc(
     *   output = "Attachmentgenie\ExampleApiV1\Model\Note",
     *   statusCodes = {
     *     200 = "Returned when successful",
     ...
     * @ApiDoc(
     *   resource = true,
     *   input = "Attachmentgenie\ExampleApiV1\Form\NoteType",
     *   statusCodes = {
     *     200 = "Returned when successful",
     ...
     *
     * @Annotations\View(
     *   template = "AttachmentgenieExampleApiV1:Note:newNote.html.twig",
     ...
     *
     * @Annotations\View(
     *   template="AttachmentgenieExampleApiV1:Note:editNote.html.twig",
     *   templateVar="form"
     * )
     *
     * @param Request $request the request object
